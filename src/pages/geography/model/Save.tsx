        ...
        return (
            ...
            >
                <Form {...formItemLayout} layout="vertical">
                    ...
                    <Form.Item key="shijian" label="生产完成时间" >
                    ...
                    <Form.Item key="biaozhun" label="指标合格标准" >
                    ...
                    <Form.Item key="process" label="指标检测进度（%）" >
