                    ...
                    <Form.Item key="status" label="状态" >
                        {getFieldDecorator('status', {
                            ...
                            <Radio.Group defaultValue="a" buttonStyle="solid">
                               <Radio.Button value="a">可用</Radio.Button>
                               <Radio.Button value="b">不可用</Radio.Button>
                            </Radio.Group>,
                        )}
                    </Form.Item>
                </Form>
